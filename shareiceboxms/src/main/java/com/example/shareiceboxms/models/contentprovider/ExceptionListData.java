...
public class ExceptionListData {
    ...
    public ExceptionListData(RecyclerView.Adapter mAdapter, Activity mActivty, ExceptionFragment exceptionFragment) {
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                try {
                    ...
                    total = d.getInt("t");
                    exceptionFragment.setCurrentPage(d.getInt("p"));
                    pagerNum = d.getInt("n");
