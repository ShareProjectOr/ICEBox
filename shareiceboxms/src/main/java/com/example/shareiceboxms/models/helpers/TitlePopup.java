...
public class TitlePopup extends PopupWindow {
    ...
    private void populateActions() {
        ...
        mListView.setAdapter(new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    textView.setTextColor(mContext.getResources().getColor(android.R.color.tab_indicator_text));
        ...
        class TitlePopAdapter extends BaseAdapter {

            public TitlePopAdapter(Activity activity) {
     ...
     * 添加子类项
     */
    public void addAction(ActionItem action, int position) {
        if (action != null) {
    ...
    public void addActionList(String[] titleArray) {
        if (titleArray.length != 0) {
            for (int position = 0; position < titleArray.length; position++) {
                mActionItems.add(position, new ActionItem(mContext, titleArray[position]));
            }
            mIsDirty = true;
        }
    }
