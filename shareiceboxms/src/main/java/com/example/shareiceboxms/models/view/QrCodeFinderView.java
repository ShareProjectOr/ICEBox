...
package com.example.shareiceboxms.models.view;
...
import com.example.shareiceboxms.models.utils.ScreenUtils;
...
public final class QrCodeFinderView extends RelativeLayout {
    ...
    public QrCodeFinderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint = new Paint();
        mContext =context;
        mMaskColor = ContextCompat.getColor(context, R.color.qr_code_finder_mask);
        mFrameColor =  ContextCompat.getColor(context,R.color.qr_code_finder_frame);
        mLaserColor =  ContextCompat.getColor(context,R.color.blue);
        mTextColor =  ContextCompat.getColor(context,R.color.qr_code_white);
