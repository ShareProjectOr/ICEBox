...
public class ItemTradeTotal {
   ...
   /* totalMoney:1500.00,//Number 交易总金额
    ...
    realReceiveMoney:1100.00,//Number 实收金额
    ...
    refundMoney:100.00,//Number  创建结算工单时退款总金额
    totalOffsetMoney:234234//累积退回的结算金额
    ...
    offsettedMoney:10.00,//Number 已冲抵金额
    ...
    public String realReceiveMoney;
    ...
    public String offsettedMoney;
    public String unoffsetMoney;
    public String totalOffsetMoney;
    ...
    public static ItemTradeTotal bindTradeTotal(JSONObject item) throws JSONException {
        ...
        try {
            itemTradeTotal.totalMoney = item.getString("totalMoney");
            itemTradeTotal.unreceiveMoney = item.getString("unreceiveMoney");
            itemTradeTotal.receiveMoney = item.getString("receiveMoney");
            itemTradeTotal.realReceiveMoney = item.getString("realReceiveMoney");
            ...
            itemTradeTotal.offsettedMoney = item.getString("offsettedMoney");
            ...
            itemTradeTotal.totalOffsetMoney = item.getString("totalOffsetMoney");
