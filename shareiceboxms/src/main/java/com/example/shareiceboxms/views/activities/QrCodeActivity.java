...
import com.example.shareiceboxms.models.camera.CameraManager;
import com.example.shareiceboxms.models.decode.CaptureActivityHandler;
import com.example.shareiceboxms.models.decode.DecodeManager;
import com.example.shareiceboxms.models.decode.InactivityTimer;
import com.example.shareiceboxms.models.view.QrCodeFinderView;
...
public class QrCodeActivity extends Activity implements Callback, OnClickListener {
    ...
    private void handleResult(String resultString) {
        if (TextUtils.isEmpty(resultString)) {
            ...
            intent.putExtra("QR_CODE", resultString);
            setResult(-1, intent);
            finish();
