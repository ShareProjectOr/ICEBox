...
public class MenuDialogAdapter extends BaseAdapter {
    ...
    private List<ItemBase> menuDatas;
    private int selectedPos = -1;
    private int mSelectedBackgroundResource;//选中item时的背景颜色
    private int mNormalBackgroundResource;//未选中的背景颜色
    ...
    public MenuDialogAdapter(Context mContext, List<ItemBase> menuDatas) {
    ...
    public void setData(List<ItemBase> data) {
        this.menuDatas = data;
        notifyDataSetChanged();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ItemBase menuData = menuDatas.get(position);
        ...
        //选中后的标题字体颜色
        nameText.setTextColor(selectedPos == position ? ContextCompat.getColor(mContext,R.color.orange) :ContextCompat.getColor(mContext,R.color.black));
        //选中与未选中的背景色
