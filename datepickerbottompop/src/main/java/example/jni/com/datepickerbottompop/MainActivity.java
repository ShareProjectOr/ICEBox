package example.jni.com.datepickerbottompop;
...
import widget.BottomDatePicker;
import widget.BottomDoublePicker;
...
public class MainActivity extends AppCompatActivity {
    ...
    private BottomDoublePicker datePicker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePicker = new BottomDoublePicker(this);
        datePicker.setOnDateSetListener(new onDateSetListener() {
            @Override
            public void onDateSet(int startYear, int startMonthOfYear, int startDayOfMonth, int endYear, int endMonthOfYear, int endDayOfMonth) {
                Toast.makeText(getApplication(), startYear + "-" + startMonthOfYear + "-" + startDayOfMonth + "&&" +
                        endYear + "-" + endMonthOfYear + "-" + endDayOfMonth, Toast.LENGTH_LONG).show();
            }

            @Override
            public void onDateSet(int Year, int MonthOfYear, int startDayOfMonth) {
